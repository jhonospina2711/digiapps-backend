package com.nexti.springboot.backend.apirest.controllers;
...
public class ClienteRestController {
	...
	public ResponseEntity<?> create(@Valid @RequestBody Cliente cliente,BindingResult result) {
		...
		if(result.hasErrors()) {
			...
			/*//Está función permite capturar un listado de errors, funciona en versiones anteriores a java 8  
			List<String> errors = new ArrayList<>();
			for (FieldError err: result.getFieldErrors()) {
				errors.add("El campo" + err.getField() + "' " + err.getDefaultMessage());
			}*/
			
			//Se crea la función q permite capturar un listado de errors, funciona en versiones iguales o superiores a java 8
